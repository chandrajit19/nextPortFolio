...
const  ProjectsPage=()=> {
  return (
    <div className="py-6 bg-bg-color">
      <div className="container mx-auto px-4 md:px-25 xl:px-30 pb-7">
        <h1 className="font-heading   text-text-color pb-2 border-b-2 border-b-emerald-600 inline-block all-headings">All Projects</h1>
