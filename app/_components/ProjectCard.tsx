...
const  ProjectCard=({ id, name, image, brief, link1, link2 }: ProjectCardProps) =>{
  return (
    <div className=" rounded-lg  overflow-hidden group">
      <div className='p-1 bg-white rounded-b-3xl rounded-t-xl  md:blur-[.5px]     brightness-75 group-hover:blur-none group-hover:bg-transparent group-hover:brightness-100 group-hover:scale-102 transition-all duration-500'>
